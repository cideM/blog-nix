...
let
  sources = {
    ...
    "@bugsnag/browser-7.0.1" = {
      ...
      version = "7.0.1";
      src = fetchurl {
        url = "https://registry.npmjs.org/@bugsnag/browser/-/browser-7.0.1.tgz";
        sha512 = "UbgX17kMWOz43h4Cm9ZZDotxPWTQYd7LToSVBYVxsaI7RZCk3ci8r/ws1uoGwAsmuUfObcvQR2dYzAYRVer4EA==";
      };
    };
    "@bugsnag/js-7.0.1" = {
      ...
      version = "7.0.1";
      src = fetchurl {
        url = "https://registry.npmjs.org/@bugsnag/js/-/js-7.0.1.tgz";
        sha512 = "tReGOFCDUG1kWCNQ9AvCkVHnL015wYYAsg4XGK1hkdUIUoJk7qL8kuDRjpIe7x3vtOYi12IxZbI9mnzGiK8AsA==";
      };
    };
    "@bugsnag/node-7.0.1" = {
      ...
      version = "7.0.1";
      src = fetchurl {
        url = "https://registry.npmjs.org/@bugsnag/node/-/node-7.0.1.tgz";
        sha512 = "/TB0W2hCm1l0XAnUn58MJsRMTA+ti0/4fNU9sPpCMEJkfatnRzGCscpYOvbzSARTW1xG445HZkYeAeRome/v8w==";
      };
    };
    "@jest/types-24.9.0" = {
    ...
    "@netlify/build-0.4.15" = {
      ...
      version = "0.4.15";
      src = fetchurl {
        url = "https://registry.npmjs.org/@netlify/build/-/build-0.4.15.tgz";
        sha512 = "qweaSCFrzw+Dcd5DL6DIY/4m+FqBElJEdd47MyfVDm0VTzaNuhCPseHTb+Nbxl9VMC2H49+7eFXoyiHeR+3NlQ==";
      };
    };
    ...
    "@netlify/config-0.11.2" = {
      ...
      version = "0.11.2";
      src = fetchurl {
        url = "https://registry.npmjs.org/@netlify/config/-/config-0.11.2.tgz";
        sha512 = "F9J3K84g6KMQyUgn/0DjcrB4feupkYNIalCoepRJHkDj55H3K10oCp4J7itKGkPBIH6vVtt5tLNE35RVho7+sw==";
      };
    };
    ...
    "@netlify/open-api-0.13.4" = {
      name = "_at_netlify_slash_open-api";
      packageName = "@netlify/open-api";
      version = "0.13.4";
      src = fetchurl {
        url = "https://registry.npmjs.org/@netlify/open-api/-/open-api-0.13.4.tgz";
        sha512 = "HMBKoBfAtW9NB1MoVxfNAQwrDg2hfQx9pYxwq1OdoPCc0tp7/vn5vzKs4uaa0ZFC0HxH04uThd5HGA9DGa1iew==";
      };
    };
    ...
    "@netlify/zip-it-and-ship-it-0.4.0-16" = {
      ...
      version = "0.4.0-16";
      src = fetchurl {
        url = "https://registry.npmjs.org/@netlify/zip-it-and-ship-it/-/zip-it-and-ship-it-0.4.0-16.tgz";
        sha512 = "lZKzDhwfMpcjpDtZxbWv4IWowdAo7T9I1qa3UFKiQxD0MoZhvvqEmfVX7jX2dgZQtUsnlLwC1wYufiPLYSkDtg==";
      };
    };
    ...
    "@oclif/command-1.6.0" = {
      ...
      version = "1.6.0";
      src = fetchurl {
        url = "https://registry.npmjs.org/@oclif/command/-/command-1.6.0.tgz";
        sha512 = "jHLlsi8WzCNTlbSWFBkpNkYdhg7tOV7aV4Kfig+2hbFxuwgf8HTRVzVKBLDmhySWdbzjg1Z7yOpne8rU4hVc8g==";
      };
    };
    "@oclif/config-1.15.1" = {
    ...
    "@oclif/plugin-help-3.0.0" = {
      ...
      version = "3.0.0";
      src = fetchurl {
        url = "https://registry.npmjs.org/@oclif/plugin-help/-/plugin-help-3.0.0.tgz";
    ...
    "netlify-4.1.2" = {
      ...
      version = "4.1.2";
      src = fetchurl {
        url = "https://registry.npmjs.org/netlify/-/netlify-4.1.2.tgz";
        sha512 = "AVffs4QmFtDJFL47pbN7/f+gSC2PzozdXnQ3SjfnjRvwhAtxVuOSzcFik+pNuDSuHx7ud/92WYReETzKc/+FPQ==";
      };
    };
    "netlify-redirect-parser-2.4.3" = {
      name = "netlify-redirect-parser";
      packageName = "netlify-redirect-parser";
      version = "2.4.3";
      src = fetchurl {
        url = "https://registry.npmjs.org/netlify-redirect-parser/-/netlify-redirect-parser-2.4.3.tgz";
        sha512 = "EyfpyfFvz2sp9d7tlWwarqkE7maDIxOx3bCqb28QY7grf6YLK3CW9vN6Y+4cDb9Anzim+1wim+egRZ4/eW30Jw==";
      };
    };
    ...
    "stackframe-1.1.1" = {
      ...
      version = "1.1.1";
      src = fetchurl {
        url = "https://registry.npmjs.org/stackframe/-/stackframe-1.1.1.tgz";
        sha512 = "0PlYhdKh6AfFxRyK/v+6/k+/mMfyiEBbTM5L94D0ZytQnJ166wuwoTYLHFWGbs2dpA8Rgq763KGWmN1EQEYHRQ==";
      };
    };
    "static-extend-0.1.2" = {
      name = "static-extend";
...
in
{
  netlify-cli = nodeEnv.buildNodePackage {
    ...
    src = fetchurl {
      ...
      sha512 = "LSXTBjJB+Wj8no2VBkZiiIAX0I7eY8Vpzjuyo2bKdI74+nBKqzLeLZjC/6GHhJuEeO42/sCIKVWVtdf1+0cN/A==";
    };
    dependencies = [
      ...
      sources."@bugsnag/browser-7.0.1"
      sources."@bugsnag/js-7.0.1"
      sources."@bugsnag/node-7.0.1"
      sources."@jest/types-24.9.0"
      sources."@mrmlnc/readdir-enhanced-2.2.1"
      (sources."@netlify/build-0.4.15" // {
        dependencies = [
      ...
      sources."@netlify/open-api-0.13.4"
      (sources."@netlify/run-utils-0.1.1" // {
        dependencies = [
          sources."execa-3.4.0"
        ];
      })
      sources."@netlify/zip-it-and-ship-it-0.4.0-16"
      ...
      (sources."@oclif/command-1.6.0" // {
        dependencies = [
          sources."@oclif/plugin-help-3.0.0"
      ...
      sources."netlify-redirect-parser-2.4.3"
